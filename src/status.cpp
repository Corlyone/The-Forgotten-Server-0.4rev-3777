...
void ProtocolStatus::sendStatusString(bool sendPlayers)
{
	if (OutputMessage_ptr output = OutputMessagePool::getInstance()->getOutputMessage(this, false))
	{
		...
		sprintf(buffer, "%llu", (unsigned long long)getUptime());
		...
		sprintf(buffer, "%lld", (long long)g_config.getNumber(ConfigManager::LOGIN_PORT));
		...
		sprintf(buffer, "%lld", (long long)real);
		xmlSetProp(p, (const xmlChar*)"online", (const xmlChar*)buffer);
		sprintf(buffer, "%lld", (long long)ips);
		xmlSetProp(p, (const xmlChar*)"unique", (const xmlChar*)buffer);
		sprintf(buffer, "%lld", (long long)g_config.getNumber(ConfigManager::MAX_PLAYERS));
		xmlSetProp(p, (const xmlChar*)"max", (const xmlChar*)buffer);
		sprintf(buffer, "%lld", (long long)g_game.getPlayersRecord());
		...
		sprintf(buffer, "%lld", (long long)g_game.getMonstersOnline());
		xmlSetProp(p, (const xmlChar*)"total", (const xmlChar*)buffer);
		xmlAddChild(root, p);

		p = xmlNewNode(NULL, (const xmlChar*)"npcs");
		sprintf(buffer, "%lld", (long long)g_game.getNpcsOnline());
		xmlSetProp(p, (const xmlChar*)"total", (const xmlChar*)buffer);
		xmlAddChild(root, p);
		...
		sprintf(buffer, "%llu", (unsigned long long)mapWidth);
		xmlSetProp(p, (const xmlChar*)"width", (const xmlChar*)buffer);
		sprintf(buffer, "%llu", (unsigned long long)mapHeight);
